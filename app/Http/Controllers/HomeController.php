...
{
    public function index(CloudSunnyPricingService $pricing, \App\Services\CloudSunnyApiService $api, \App\Services\CloudSunnyAccountRouter $router)
    {
