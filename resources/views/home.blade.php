            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                @foreach($plans as $pid => $p)
                    @php 
                        ...
                        $networkSpeed = (int) ($p['network_out_mbps'] ?? 100);
                    ...
                    <div class="relative bg-white rounded-2xl p-8 flex flex-col
                        ...
                        <ul class="space-y-4 flex-grow mb-8 text-sm text-gray-700">
                            ...
                            <li class="flex items-center gap-3">
                                <svg class="text-cloud-500" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 15L12 18.75 15.75 15m-7.5-6L12 5.25 15.75 9" /></svg>
                                <span class="font-medium">Tốc độ mạng: {{ $networkSpeedLabel }}</span>
                            </li>
                        </ul>
