...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            ...
            <p class="text-sm text-gray-500 mb-4 flex-grow">Kết nối qua mạng xã hội Facebook để được hỗ trợ và cập nhật thông tin.</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
            <div class="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-4 text-[#0084FF]">
                <svg width="32" height="32" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
            </div>
            <h3 class="text-lg font-bold text-gray-900 mb-2">Nhóm Facebook</h3>
            <p class="text-sm text-gray-500 mb-4 flex-grow">Tham gia cộng đồng để trao đổi, học hỏi và nhận thông báo mới nhất.</p>
            <a href="https://m.me/j/AbargYsJDRmKjR9x/?send_source=gc%3Acopy_invite_link_t" target="_blank" rel="noopener noreferrer" class="w-full inline-flex justify-center items-center gap-2 px-4 py-2 bg-[#0084FF] text-white rounded-lg hover:bg-blue-600 font-medium transition-colors">
                Tham gia Nhóm
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
                    <h4 class="font-semibold text-gray-900 text-sm mb-1">Mua thêm disk rồi tại sao không nhận được?</h4>
                    <p class="text-sm text-gray-600">
                        Sau khi mua thêm, nếu disk không tăng thì cần làm như sau:<br>
                        - Bấm tổ hợp phím <strong>Win + R</strong><br>
                        - Nhập <strong>diskmgmt.msc</strong><br>
                        - Nhấn <strong>Enter</strong>
                    </p>
                </div>
            </div>
        </div>
